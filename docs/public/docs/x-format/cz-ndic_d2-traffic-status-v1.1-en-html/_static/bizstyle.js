...
window.addEventListener("resize",
  () => (document.querySelector("li.nav-item-0 a").innerText = (window.innerWidth <= 776) ? "Top" : "NDIC - DATEX II Elaborated Data Publication - Traffic Status 1.1rev0 documentation")
)
