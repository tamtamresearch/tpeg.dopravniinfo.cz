...
window.addEventListener("resize",
  () => (document.querySelector("li.nav-item-0 a").innerText = (window.innerWidth <= 776) ? "Top" : "Dokumentace pro NDIC - DATEX II Predefined Location Publication - Sada předdefinovaných poloh 1.2rev0")
)
