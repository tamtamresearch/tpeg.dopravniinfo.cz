...
window.addEventListener("resize",
  () => (document.querySelector("li.nav-item-0 a").innerText = (window.innerWidth <= 776) ? "Top" : "Dokumentace pro NDIC - DATEX II Measurement Site Table Publication - Sada předdefinovaných zařízení 1.0rev0")
)
