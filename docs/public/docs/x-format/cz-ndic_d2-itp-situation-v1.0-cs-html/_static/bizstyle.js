...
window.addEventListener("resize",
  () => (document.querySelector("li.nav-item-0 a").innerText = (window.innerWidth <= 776) ? "Top" : "Dokumentace pro NDIC DATEX II Parking Situation Publication – Situace na parkovištích nákladních vozidel 1.0rev0")
)
