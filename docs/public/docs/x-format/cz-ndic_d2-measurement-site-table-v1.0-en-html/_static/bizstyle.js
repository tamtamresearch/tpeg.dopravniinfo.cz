...
window.addEventListener("resize",
  () => (document.querySelector("li.nav-item-0 a").innerText = (window.innerWidth <= 776) ? "Top" : "NDIC - DATEX II Measurement Site Table Publication - Predefined Equipment Set 1.0rev0 documentation")
)
