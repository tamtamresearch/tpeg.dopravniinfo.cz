...
window.addEventListener("resize",
  () => (document.querySelector("li.nav-item-0 a").innerText = (window.innerWidth <= 776) ? "Top" : "NDIC - DATEX II Predefined Location Publication - Predefined Location Set 1.1rev0 documentation")
)
