...
window.addEventListener("resize",
  () => (document.querySelector("li.nav-item-0 a").innerText = (window.innerWidth <= 776) ? "Top" : "Dokumentace pro NDIC - DATEX II Situation Publication - Uzavírky a omezení 1.1rev0")
)
