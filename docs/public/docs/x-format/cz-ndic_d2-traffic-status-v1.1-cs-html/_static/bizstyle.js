...
window.addEventListener("resize",
  () => (document.querySelector("li.nav-item-0 a").innerText = (window.innerWidth <= 776) ? "Top" : "Dokumentace pro NDIC - DATEX II Elaborated Data Publication - Hustota provozu 1.1rev0")
)
