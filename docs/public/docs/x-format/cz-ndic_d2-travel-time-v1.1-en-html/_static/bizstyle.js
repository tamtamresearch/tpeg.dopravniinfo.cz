...
window.addEventListener("resize",
  () => (document.querySelector("li.nav-item-0 a").innerText = (window.innerWidth <= 776) ? "Top" : "NDIC - DATEX II Elaborated Data Publication - Travel time 1.1rev0 documentation")
)
